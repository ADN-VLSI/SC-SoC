...
| ------------ | --------------------------- | --------------------------------- |
| `FIFO_DEPTH` | `uart_pkg::UART_FIFO_DEPTH` | Depth of both TX and RX CDC FIFOs |
...
| _(fixed `'d4`)_         | `u_tx_clk_div.div_i`    |
...
| `uart_cfg.sb`  | `u_uart_tx.extra_stop_i`  | _(not connected)_         |
...
| `uart_pkg`         | Subsystem-level parameters (e.g. `UART_FIFO_DEPTH`)      |
