...
int main () {
    ...
    if ((REG_UART_RXD & 0x000000FF) != 'i')  error |= 0x00000002;
    if ((REG_UART_RXD & 0x000000FF) != ' ')  error |= 0x00000004;
    if ((REG_UART_RXD & 0x000000FF) != 'S')  error |= 0x00000008;
    if ((REG_UART_RXD & 0x000000FF) != 'C')  error |= 0x00000010;
    if ((REG_UART_RXD & 0x000000FF) != '-')  error |= 0x00000020;
    if ((REG_UART_RXD & 0x000000FF) != 'S')  error |= 0x00000040;
    if ((REG_UART_RXD & 0x000000FF) != 'o')  error |= 0x00000080;
    if ((REG_UART_RXD & 0x000000FF) != 'C')  error |= 0x00000100;
    if ((REG_UART_RXD & 0x000000FF) != '.')  error |= 0x00000200;
    if ((REG_UART_RXD & 0x000000FF) != '.')  error |= 0x00000400;
